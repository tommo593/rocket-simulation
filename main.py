...
## SETUP - constant variables, game settings etc
## Display setup
...
## Class for spacecraft. Movement speed etc
...
## def means function. double underscores are called "dunder", only call this function if we run this file directly
## while loop
...
def main():
  ...
  ## Build large objects on screen
    planet = Planet(WIDTH // 2, HEIGHT // 2, PLANET_MASS)
    objects = []
    temp_obj_pos = None

    ## Looping through all events occurring from pygame and checking to see if its equal to a specific one
    while running:
        clock.tick(FPS)
     ...
     ## "blit" puts an image on the screen
        win.blit(BG, (0, 0))
